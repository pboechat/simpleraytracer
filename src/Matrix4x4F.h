...
public:
	...
	inline Matrix4x4F operator * (const Matrix4x4F& rOther)
	{
		...
		float m13 = mMatrix[0] * rOther.mMatrix[2] + mMatrix[1] * rOther.mMatrix[6] + mMatrix[2] * rOther.mMatrix[9] + mMatrix[3] * rOther.mMatrix[14];
	...
	inline Matrix4x4F Transpose() const
	{
		return Matrix4x4F(mMatrix[0], mMatrix[4], mMatrix[8], mMatrix[12],
						  ...
						  mMatrix[3], mMatrix[8], mMatrix[11], mMatrix[15]);
	}
